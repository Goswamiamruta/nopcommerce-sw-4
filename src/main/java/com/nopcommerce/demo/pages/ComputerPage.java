...
By computerMenu = By.xpath("(//a[normalize-space()='Computers'])[1]");
...
By ramLink = By.id("product_attribute_2");
    ...
    By soppingCart = By.xpath("//span[contains(text(),'Shopping cart')]");
    ...
    public void mouseHoverOnShoppingCartAndClick(){
        mouseHoverToElementAndClick(soppingCart);
    }
    public void moveToShoppingCart(){
        mouseHoverToElement(soppingCart);
    }
