...
public class ElectronicsTest extends TestBase {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
       ...
       //2.18 Click on “REGISTER” tab
        ...
        register.inputFirstname("amruta");
        register.inputLastname("Goswami");
        register.inputEmail("Amrutagoswami123@gmail.com");
        register.inputPassword("amruta1234");
        register.inputConfirmPassword("amruta1234");
       ...
       //Assert.assertEquals(actualRegisterSuccessMessage,"Your registration completed","error");
        ...
        sendTextToElement(By.xpath("//input[@id='Email']"),"Amruta123@gmail.com");
        sendTextToElement(By.xpath("//input[@id='Password']"),"amruta1234");
        ...
        checkout.inputFirstname("Amruta");
        checkout.inputLastname("Goswami");
        // checkout.inputEmail("Amruta123@gmail.com");
        checkout.selectCountry("United Kingdom");
        checkout.inputCity("London");
        checkout.inputAddress1("10 Harrow Street");
        checkout.inputPostalCode("Ha3 1PH");
        ...
        checkout.inputCardHolderName("Amruta Goswami");
