...
public class ComputerTest extends TestBase {
    ...
    public void verifyProductArrangeInAlphabeticalOrder() {
        ...
        List<Double> beforeFilterNameZtoAList1 = new ArrayList<>();
        for (WebElement nameZtoA : beforeFilterNameZtoAList) {
            beforeFilterNameZtoAList1.add(Double.valueOf(nameZtoA.getText().replace("$", "")));
        }
        ...
        List<Double> afterFilterNameZtoAList1 = new ArrayList<>();
        for (WebElement nameZtoA : beforeFilterNameZtoAList) {
            afterFilterNameZtoAList1.add(Double.valueOf(nameZtoA.getText().replace("$", "")));

        }
        //1.4 Verify the Product will arrange in Descending order.
        Collections.sort(beforeFilterNameZtoAList1);
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
       ...
       // computerPage.addToCart();
        ...
        String actualWelcomeSignInText = computerPage.getWelcomeOurStoreText();
        ...
        computerPage.inputFirstname("Amruta");
        computerPage.inputLastname("Goswami");
        computerPage.inputEmail("amruta123@gmail.com");
        computerPage.selectCountry("United Kingdom");
        computerPage.inputCity("London");
        computerPage.inputAddress1("93 harrow street");
        computerPage.inputPostalCode("ha3 9tf");
        computerPage.inputPhoneNumber("9429021798");
        ...
        computerPage.inputCardHolderName("Amruta Goswami");
